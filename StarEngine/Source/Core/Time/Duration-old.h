...
public:
    ...
    explicit Duration(Years year)
    {
        
    }

    explicit Duration(Months month)
    {

    }

    explicit Duration(Days day)
    {

    }

    explicit Duration(Hours hour)
    {

    }

    explicit Duration(Minutes minute)
    {

    }

    explicit Duration(Seconds second)
    {

    }

    explicit Duration(Milliseconds ms)
    {

    }

    explicit Duration(Microseconds us)
    {

    }

    explicit Duration(Nanoseconds ns)
    {
